...
class Venta
{
    ...
    public function __construct($nombreDeUsuario,$unHelado,$cantidad,$cuponDeDescuento = null,$ruta = null,$nombreDelaImagen = null) {
    ...
    {
        $estado = false;
        if(File::MoverFoto($this->rutaDeLafoto,$nuevaRuta,$this->nombreDeLaImagen))
        {
            $this->rutaDeLafoto = $nuevaRuta;
            $estado = true;
        }
...
// e- El listado de ventas por vaso Cucurucho.
    ...
    public static function Borrar($listaDeVentas,$index)
    {
        ...
        if(isset($listaDeVentas) && $index >= 0)
        {
            $listaDeVentas[$index]->MoverImagen("ImagenesBackupVentas/2024/");
    ...
    {
        return "nombreDeUsuario: ".$this->nombreDeUsuario.'<br>'.
          "email: ".$this->email.'<br>'
